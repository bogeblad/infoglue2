...
public class PortalController {
     ...
     * Render portlet
     * 
     * @param portletID Unique identifier (myPortlet.MyPortletName of the portlet to be rendered
     * @param windowId Unique identifier of the window that is to be rendered, if a PortletWindow 
     * with windowId don't exist in the registry it's created and added to the registry.
     * @return the content the portlet produces
     * @throws PortalException
     */
    public String renderFragment(String portletID, String windowID)
     ...
     * @param portletID identifies the portlet instance.
     * @param windowId Unique identifier of the window that is to be rendered, if a PortletWindow 
     * with windowId don't exist in the registry it's created and added to the registry.
     * @return a PortletWindowIG for a portlet instance
     * @throws NameNotFoundException thrown if the identifier is not bound to a portlet instance  
     * @throws PortalException thrown in case of an exception while initializing the portlet.
     */
