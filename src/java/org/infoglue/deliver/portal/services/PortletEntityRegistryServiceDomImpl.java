...
import org.infoglue.deliver.portal.OmBuilderDomImpl;
 ...
 */
public class PortletEntityRegistryServiceDomImpl extends PortletEntityRegistryService {
    private static final Log LOG = LogFactory
            .getLog(PortletEntityRegistryServiceDomImpl.class);
    ...
    protected void init(ServletContext aContext, Properties aProperties)
        ...
        OmBuilder builder = new OmBuilderDomImpl(is);
