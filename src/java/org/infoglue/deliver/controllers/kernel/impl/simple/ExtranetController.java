...
public class ExtranetController extends BaseDeliveryController
{
	...
	public Principal getAuthenticatedPrincipal(Map request, HttpServletRequest httpRequest) throws Exception
	{		
		Principal principal = null;
		
		try
		{			
			String authenticatedUserName = AuthenticationModule.getAuthenticationModule(null, null, httpRequest, false).authenticateUser(request);
			logger.info("authenticatedUserName:" + authenticatedUserName);
			if(authenticatedUserName != null)
			{
