	...
	*/
	...
	public List getAssets(String propertyName, boolean useInheritance, boolean useRepositoryInheritance, boolean useStructureInheritance) throws Exception
	{
		...
		{	
			...
			while(bindingsIterator.hasNext())
			{
				...
				Integer boundContentId 	= new Integer(componentBinding.getEntityId());
	...
	public List getChildContents(String propertyName, boolean useInheritance, boolean searchRecursive, String sortAttribute, String sortOrder, boolean includeFolders, boolean useRepositoryInheritance, boolean useStructureInheritance)
	{
		...
		{	
			...
			while(bindingsIterator.hasNext())
			{
				Integer contentId = new Integer(bindingsIterator.next().getEntityId());
	...
	public List getChildPages(String propertyName, boolean useInheritance, boolean escapeHTML, boolean hideUnauthorizedPages, boolean useRepositoryInheritance, boolean useStructureInheritance, Integer levelsToPopulate, String nameFilter)
	{
		...
		{	
			...
			while(bindingsIterator.hasNext())
			{
				Integer siteNodeId = new Integer(bindingsIterator.next().getEntityId());
    ...
    public Integer getContentId(Map property)
	{
		...
		{	
			...
			if(bindings.size() > 0)
			{
				...
				boundContentId = new Integer(componentBinding.getEntityId());
	...
	*/
	...
	public List<ContentVO> getBoundContents(Map property)
	{
		...
		{	
			...
			{
				ComponentBinding componentBinding = bindingsIterator.next();
				Integer contentId = new Integer(componentBinding.getEntityId());
	...
	*/
	...
	public Integer getSiteNodeId(Map property)
	{
		...
		{	
			...
			{
				ComponentBinding componentBinding = bindings.get(0);
			    siteNodeId = new Integer(componentBinding.getEntityId());
			}
		}
	...
	*/
	...
	public List<SiteNodeVO> getBoundSiteNodes(Map property)
	{
		...
		{	
			...
			{
				ComponentBinding componentBinding = bindingsIterator.next();
			    Integer siteNodeId = new Integer(componentBinding.getEntityId());
			    SiteNodeVO siteNodeVO = templateController.getSiteNode(siteNodeId);
				if(siteNodeVO != null)
		...
		if(property != null)
		{
			...
			while(bindingsIterator.hasNext())
			{
				try
				{
					...
					{
						String entityId = componentBinding.getEntityId();
