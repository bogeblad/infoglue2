...
public class DecoratedComponentLogic extends ComponentLogic
{
	...
	private org.infoglue.deliver.applications.actions.InfoGlueComponent infoGlueComponent = null;

	public DecoratedComponentLogic(TemplateController templateController, org.infoglue.deliver.applications.actions.InfoGlueComponent infoGlueComponent)
	{
