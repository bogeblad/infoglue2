	...
	private void printThread()
	{
		...
		{			
	        ...
	        if(warningEmailReceiver != null && !warningEmailReceiver.equals("") && warningEmailReceiver.indexOf("@warningEmailReceiver@") == -1)
	        {
				try
				{
					MailServiceFactory.getService().sendEmail("text/html", warningEmailReceiver, warningEmailReceiver, null, null, null, null, message, stackString.toString().replaceAll("\n", "<br/>"), "utf-8");
				} 
				catch (Exception e)
				{
