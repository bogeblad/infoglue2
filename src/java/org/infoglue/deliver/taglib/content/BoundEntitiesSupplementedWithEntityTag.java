 ...
 *
 */
public class BoundEntitiesSupplementedWithEntityTag extends ComponentLogicTag
{
	...
	public int doEndTag() throws JspException
    {
        if(siteNodeId == null)
        {
        	setResultAttribute(getComponentLogic().getBoundEntitiesSupplementedWithEntity(propertyName, useInheritance, useRepositoryInheritance, useStructureInheritance));
        }
        else
        {
