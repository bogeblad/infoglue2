...
public class ContentTypeDefinitionAttributesTag extends TemplateControllerTag 
{
	...
	public ContentTypeDefinitionAttributesTag()
    {
        super();
    }
    ...
    {
	    //if(languageId != null)
	        setResultAttribute(getController().getContentAttributes(this.schemaValue));
	    /*
