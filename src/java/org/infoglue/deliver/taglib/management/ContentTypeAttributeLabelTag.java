...
public class ContentTypeAttributeLabelTag extends TemplateControllerTag
{
	...
	public int doEndTag() throws JspException
	{
		try
		{
			...
			if (attributeValue != null)
			{
				...
				label = getAttributeValueLabel(getController(), ctd.getSchemaValue(), attribute, attributeValue);
			}
			else
			{
				// Otherwise just get localized label of the attribute
				label = getAttributeLabel(getController(), ctd.getSchemaValue(), attribute);
			}
	 ...
	 * @throws SystemException
	 */
	private static String getAttributeLabel(TemplateController pc, String schema, String attributeName) throws SystemException
	{
		Locale currentLocale = pc.getLocale();
		ContentTypeAttribute attr = getContentTypeDefinitionAttribute(schema, attributeName);
	...
	private static String getAttributeValueLabel(TemplateController pc,
			String schema, String attributeName, String attributeValueName)
			throws SystemException
	{
		Locale currentLocale = pc.getLocale();
		ContentTypeAttribute attr = getContentTypeDefinitionAttribute(schema, attributeName);
	...
	private static ContentTypeAttribute getContentTypeDefinitionAttribute(String schema, String attributeName) throws SystemException
	{
		List<ContentTypeAttribute> attrs = ContentTypeDefinitionController.getController().getContentTypeAttributes(schema);
