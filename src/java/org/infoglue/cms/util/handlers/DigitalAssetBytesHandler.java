 ...
 * @version $Revision: 1.7.4.1 $ $Date: 2012/12/10 01:29:51 $
**/
...
{	
    ...
    public Object getValue( Object object ) throws IllegalStateException
    {
    	...
    	if((getMaxSize() == 0)/* || asset.getAssetFileSize() == 0*/)
    	{
    		returnArray = "ref".getBytes();
    	}
    	else if((getMaxSize() != -1 && asset.getAssetFileSize() > getMaxSize())/* || asset.getAssetFileSize() == 0*/)
    	{
