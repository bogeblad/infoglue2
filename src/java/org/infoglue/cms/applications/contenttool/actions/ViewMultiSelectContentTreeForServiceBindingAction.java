...
public class ViewMultiSelectContentTreeForServiceBindingAction extends InfoGlueAbstractAction
{
	...
	public ViewMultiSelectContentTreeForServiceBindingAction(ServiceBindingVO serviceBindingVO)
	{
	...
	{
		return "ViewMultiSelectContentTreeForServiceBinding.action";
	}
