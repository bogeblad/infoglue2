...
public class ViewStructureRelationEditorAction extends ViewRelationEditorAction
{
    ...
    {
    	this.currentAction 				= "ViewStructureRelationEditor.action";
    	this.changeRepositoryAction 	= "ViewStructureRelationEditor!changeRepository.action";
	...
	public ViewStructureRelationEditorAction getThis()
	{
		return this;
	}
