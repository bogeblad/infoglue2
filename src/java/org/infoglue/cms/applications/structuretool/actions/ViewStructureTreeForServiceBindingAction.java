...
public class ViewStructureTreeForServiceBindingAction extends WebworkAbstractAction
{
	...
	public ViewStructureTreeForServiceBindingAction(ServiceBindingVO serviceBindingVO)
	{
	...
	{
		return "ViewStructureTreeForServiceBinding.action";
	}
