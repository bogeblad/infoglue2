...
public class ViewMultiSelectStructureTreeForServiceBindingAction extends WebworkAbstractAction
{
	...
	public ViewMultiSelectStructureTreeForServiceBindingAction getThis()
	{
		return this;
	}
