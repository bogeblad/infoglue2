...
public class PublicationController extends BaseController
{
	...
	public static PublicationVO createAndPublish(PublicationVO publicationVO, List events, InfoGluePrincipal infoGluePrincipal) throws ConstraintException, SystemException
    {
    	Database db = CastorDatabaseService.getDatabase();
	...
	public static PublicationVO unPublish(Integer publicationId, InfoGluePrincipal infoGluePrincipal, String[] notOverwritableDetails) throws SystemException
	{
        ...
        try
        {
			...
			while (i.hasNext())
			{
				...
				{
					unpublishEntity(publicationDetail, LEAVE_WORKING, infoGluePrincipal, db);
				}
			}
	...
	private static void unpublishEntity(PublicationDetail publicationDetail, int unpublishMethodId, InfoGluePrincipal infoGluePrincipal, Database db) throws ConstraintException, SystemException
	{
