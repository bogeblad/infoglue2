...
public class ContentStateController extends BaseController 
{
    ...
    public static ContentVersion changeState(Integer oldContentVersionId, Integer stateId, String versionComment, InfoGluePrincipal infoGluePrincipal, Integer contentId) throws ConstraintException, SystemException
    {
		...
		try
		{
        	changeState(oldContentVersionId, stateId, versionComment, infoGluePrincipal, contentId, db);	
	...
	public static ContentVersion changeState(Integer oldContentVersionId, Integer stateId, String versionComment, InfoGluePrincipal infoGluePrincipal, Integer contentId, Database db) throws ConstraintException, SystemException
    {
    	ContentVersion newContentVersion = null; 
        ...
        { 
	    	...
	    	if(stateId.intValue() == ContentVersionVO.PUBLISH_STATE.intValue())
	    	{
				...
				ContentVersionVO oldContentVersionVO = oldContentVersion.getValueObject();
