    ...
    public ContentVersionVO update(Integer contentId, Integer languageId, ContentVersionVO contentVersionVO, InfoGluePrincipal principal) throws ConstraintException, SystemException
    {
        ...
        {     
	    	...
	    	else
	    	{
				...
				{
					List events = new ArrayList();
					contentVersion = ContentStateController.changeState(oldContentVersionVO.getId(), ContentVersionVO.WORKING_STATE, "new working version", true, null, principal, oldContentVersionVO.getContentId(), db, events);
