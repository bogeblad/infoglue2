...
{
    public static ViewSiteNodeTreeUCC newViewSiteNodeTreeUCC() throws SystemException
    {
        ViewSiteNodeTreeUCC viewSiteNodeTreeUCC = new ViewSiteNodeTreeUCCImpl();
        return viewSiteNodeTreeUCC;
    }
