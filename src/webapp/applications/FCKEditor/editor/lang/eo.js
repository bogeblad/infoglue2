...
InsertLink			: "Enmeti/ÅœanÄ?i Ligilon",
RemoveLink			: "Forigi Ligilon",
Anchor				: "Enmeti/ÅœanÄ?i Ankron",
InsertImageLbl		: "Bildo",
InsertImage			: "Enmeti/ÅœanÄ?i Bildon",
InsertTableLbl		: "Tabelo",
InsertTable			: "Enmeti/ÅœanÄ?i Tabelon",
...
Done				: "Finita",
PasteWordConfirm	: "La algluota teksto Å?ajnas esti Word-devena. Äˆu vi volas purigi Ä?in antaÅ­ ol interglui?",
...
DlgLnkPopResize		: "Grando ÅœanÄ?ebla",
...
DlgPasteMsg		: "La redaktilo ne povis aÅ­tomate interglui pro la <STRONG>sekurecagordo</STRONG> de via TTT-legilo.<BR>Bonvolu interglui viajn datumojn en la Ä‰i suban tekstozonon per la klavaro (<STRONG>Ctrl-V</STRONG>) kaj musklaku la butonon <STRONG>Akceptita</STRONG>.",
...
IeSpellDownload			: "Literumada Kontrolilo ne instalita. Äˆu vi volas elÅ?uti Ä?in nun?",
