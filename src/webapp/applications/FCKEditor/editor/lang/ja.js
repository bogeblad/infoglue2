...
ToolbarCollapse		: "ãƒ„ãƒ¼ãƒ«ãƒ?ãƒ¼ã‚’éš ã?™",
ToolbarExpand		: "ãƒ„ãƒ¼ãƒ«ãƒ?ãƒ¼ã‚’è¡¨ç¤º",
...
Subscript			: "æ·»ã?ˆå­—",
Superscript			: "ä¸Šä»˜ã??æ–‡å­—",
LeftJustify			: "å·¦æ?ƒã?ˆ",
CenterJustify		: "ä¸­å¤®æ?ƒã?ˆ",
RightJustify		: "å?³æ?ƒã?ˆ",
BlockJustify		: "ä¸¡ç«¯æ?ƒã?ˆ",
...
BulletedList		: "ç®‡æ?¡æ›¸ã??ã?®è¿½åŠ /å‰Šé™¤",
...
Find				: "æ¤œç´¢",
Replace				: "ç½®ã??æ?›ã?ˆ",
SpellCheck			: "ã‚¹ãƒšãƒ«ãƒ?ã‚§ãƒƒã‚¯",
UniversalKeyboard	: "ãƒ¦ãƒ‹ãƒ?ãƒ¼ã‚µãƒ«ãƒ»ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰",
...
ImageButton		: "ç”»åƒ?ãƒœã‚¿ãƒ³",

// Context Menu
EditLink			: "ãƒªãƒ³ã‚¯ç·¨é›†",
InsertRow			: "è¡ŒæŒ¿å…¥",
DeleteRows			: "è¡Œå‰Šé™¤",
InsertColumn		: "åˆ—æŒ¿å…¥",
DeleteColumns		: "åˆ—å‰Šé™¤",
InsertCell			: "ã‚»ãƒ«æŒ¿å…¥",
DeleteCells			: "ã‚»ãƒ«å‰Šé™¤",
MergeCells			: "ã‚»ãƒ«çµ?å?ˆ",
SplitCell			: "ã‚»ãƒ«åˆ†å‰²",
...
// Alerts and Messages
ProcessingXHTML		: "XHTMLå‡¦ç?†ä¸­. ã?—ã?°ã‚‰ã??ã?Šå¾…ã?¡ã??ã? ã?•ã?„...",
Done				: "å®Œäº†",
...
NotCompatiblePaste	: "ã?“ã?®ã‚³ãƒžãƒ³ãƒ‰ã?¯ã‚¤ãƒ³ã‚¿ãƒ¼ãƒ?ãƒƒãƒˆãƒ»ã‚¨ã‚¯ã‚¹ãƒ—ãƒ­ãƒ¼ãƒ©ãƒ¼ãƒ?ãƒ¼ã‚¸ãƒ§ãƒ³5.5ä»¥ä¸Šã?§åˆ©ç”¨å?¯èƒ½ã?§ã?™ã€‚ã‚¯ãƒªãƒ¼ãƒ‹ãƒ³ã‚°ã?—ã?ªã?„ã?§è²¼ã‚Šä»˜ã?‘ã‚’è¡Œã?„ã?¾ã?™ã?‹ï¼Ÿ",
UnknownToolbarItem	: "æœªçŸ¥ã?®ãƒ„ãƒ¼ãƒ«ãƒ?ãƒ¼é …ç›® \"%1\"",
UnknownCommand		: "æœªçŸ¥ã?®ã‚³ãƒžãƒ³ãƒ‰å?? \"%1\"",
NotImplemented		: "ã‚³ãƒžãƒ³ãƒ‰ã?¯ã‚¤ãƒ³ãƒ—ãƒªãƒ¡ãƒ³ãƒˆã?•ã‚Œã?¾ã?›ã‚“ã?§ã?—ã?Ÿã€‚",
UnknownToolbarSet	: "ãƒ„ãƒ¼ãƒ«ãƒ?ãƒ¼è¨­å®š \"%1\" å­˜åœ¨ã?—ã?¾ã?›ã‚“ã€‚",

// Dialogs
DlgBtnOK			: "OK",
DlgBtnCancel		: "ã‚­ãƒ£ãƒ³ã‚»ãƒ«",
DlgBtnClose			: "é–‰ã?˜ã‚‹",
DlgBtnBrowseServer	: "ã‚µãƒ¼ãƒ?ãƒ¼ãƒ–ãƒ©ã‚¦ã‚¶ãƒ¼",
DlgAdvancedTag		: "é«˜åº¦ã?ªè¨­å®š",
DlgOpOther			: "&lt;ã??ã?®ä»–&gt;",
...
DlgImgBtnUpload		: "ã‚µãƒ¼ãƒ?ãƒ¼ã?«é€?ä¿¡",
DlgImgURL			: "URL",
...
DlgImgAlertUrl		: "ã‚¤ãƒ¡ãƒ¼ã‚¸ã?®URLã‚’å…¥åŠ›ã?—ã?¦ã??ã? ã?•ã?„ã€‚",
DlgImgLinkTab		: "Link",	//MISSING

// Link Dialog
DlgLnkWindowTitle	: "ãƒ?ã‚¤ãƒ‘ãƒ¼ãƒªãƒ³ã‚¯",
DlgLnkInfoTab		: "ãƒ?ã‚¤ãƒ‘ãƒ¼ãƒªãƒ³ã‚¯ æƒ…å ±",
...
DlgLnkProtoOther	: "&lt;ã??ã?®ä»–&gt;",
DlgLnkURL			: "URL",
DlgLnkAnchorSel		: "ã‚¢ãƒ³ã‚«ãƒ¼ã‚’é?¸æŠž",
DlgLnkAnchorByName	: "ã‚¢ãƒ³ã‚«ãƒ¼å??",
DlgLnkAnchorById	: "ã‚¨ãƒ¬ãƒ¡ãƒ³ãƒˆID",
DlgLnkNoAnchors		: "&lt;ãƒ‰ã‚­ãƒ¥ãƒ¡ãƒ³ãƒˆã?«ã?Šã?„ã?¦åˆ©ç”¨å?¯èƒ½ã?ªã‚¢ãƒ³ã‚«ãƒ¼ã?¯ã?‚ã‚Šã?¾ã?›ã‚“ã€‚&gt;",
DlgLnkEMail			: "E-Mail ã‚¢ãƒ‰ãƒ¬ã‚¹",
DlgLnkEMailSubject	: "ä»¶å??",
DlgLnkEMailBody		: "æœ¬æ–‡",
DlgLnkUpload		: "ã‚¢ãƒƒãƒ—ãƒ­ãƒ¼ãƒ‰",
DlgLnkBtnUpload		: "ã‚µãƒ¼ãƒ?ãƒ¼ã?«é€?ä¿¡",

DlgLnkTarget		: "ã‚¿ãƒ¼ã‚²ãƒƒãƒˆ",
DlgLnkTargetFrame	: "&lt;ãƒ•ãƒ¬ãƒ¼ãƒ &gt;",
DlgLnkTargetPopup	: "&lt;ãƒ?ãƒƒãƒ—ã‚¢ãƒƒãƒ—ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦&gt;",
DlgLnkTargetBlank	: "æ–°ã?—ã?„ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ (_blank)",
DlgLnkTargetParent	: "è¦ªã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ (_parent)",
DlgLnkTargetSelf	: "å?Œã?˜ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ (_self)",
DlgLnkTargetTop		: "æœ€ä¸Šä½?ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ (_top)",
DlgLnkTargetFrameName	: "ç›®çš„ã?®ãƒ•ãƒ¬ãƒ¼ãƒ å??",
DlgLnkPopWinName	: "ãƒ?ãƒƒãƒ—ã‚¢ãƒƒãƒ—ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦å??",
DlgLnkPopWinFeat	: "ãƒ?ãƒƒãƒ—ã‚¢ãƒƒãƒ—ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ç‰¹å¾´",
DlgLnkPopResize		: "ãƒªã‚µã‚¤ã‚ºå?¯èƒ½",
DlgLnkPopLocation	: "ãƒ­ã‚±ãƒ¼ã‚·ãƒ§ãƒ³ãƒ?ãƒ¼",
DlgLnkPopMenu		: "ãƒ¡ãƒ‹ãƒ¥ãƒ¼ãƒ?ãƒ¼",
DlgLnkPopScroll		: "ã‚¹ã‚¯ãƒ­ãƒ¼ãƒ«ãƒ?ãƒ¼",
DlgLnkPopStatus		: "ã‚¹ãƒ†ãƒ¼ã‚¿ã‚¹ãƒ?ãƒ¼",
DlgLnkPopToolbar	: "ãƒ„ãƒ¼ãƒ«ãƒ?ãƒ¼",
DlgLnkPopFullScrn	: "å…¨ç”»é?¢ãƒ¢ãƒ¼ãƒ‰(IE)",
DlgLnkPopDependent	: "é–‹ã?„ã?Ÿã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã?«é€£å‹•ã?—ã?¦é–‰ã?˜ã‚‹ (Netscape)",
DlgLnkPopWidth		: "å¹…",
DlgLnkPopHeight		: "é«˜ã?•",
DlgLnkPopLeft		: "å·¦ç«¯ã?‹ã‚‰ã?®åº§æ¨™ã?§æŒ‡å®š",
DlgLnkPopTop		: "ä¸Šç«¯ã?‹ã‚‰ã?®åº§æ¨™ã?§æŒ‡å®š",

DlnLnkMsgNoUrl		: "ãƒªãƒ³ã‚¯URLã‚’å…¥åŠ›ã?—ã?¦ã??ã? ã?•ã?„ã€‚",
DlnLnkMsgNoEMail	: "ãƒ¡ãƒ¼ãƒ«ã‚¢ãƒ‰ãƒ¬ã‚¹ã‚’å…¥åŠ›ã?—ã?¦ã??ã? ã?•ã?„ã€‚",
DlnLnkMsgNoAnchor	: "ã‚¢ãƒ³ã‚«ãƒ¼ã‚’é?¸æŠžã?—ã?¦ã??ã? ã?•ã?„ã€‚",

// Color Dialog
DlgColorTitle		: "è‰²é?¸æŠž",
DlgColorBtnClear	: "ã‚¯ãƒªã‚¢",
DlgColorHighlight	: "ãƒ?ã‚¤ãƒ©ã‚¤ãƒˆ",
...
DlgFindTitle		: "æ¤œç´¢",
DlgFindFindBtn		: "æ¤œç´¢",
DlgFindNotFoundMsg	: "æŒ‡å®šã?•ã‚Œã?Ÿæ–‡å­—åˆ—ã?¯è¦‹ã?¤ã?‹ã‚Šã?¾ã?›ã‚“ã?§ã?—ã?Ÿã€‚",

// Replace Dialog
DlgReplaceTitle			: "ç½®ã??æ?›ã?ˆ",
DlgReplaceFindLbl		: "æ¤œç´¢ã?™ã‚‹æ–‡å­—åˆ—:",
DlgReplaceReplaceLbl	: "ç½®æ?›ã?ˆã?™ã‚‹æ–‡å­—åˆ—:",
DlgReplaceCaseChk		: "éƒ¨åˆ†ä¸€è‡´",
DlgReplaceReplaceBtn	: "ç½®æ?›ã?ˆ",
DlgReplaceReplAllBtn	: "ã?™ã?¹ã?¦ç½®æ?›ã?ˆ",
DlgReplaceWordChk		: "å?˜èªžå?˜ä½?ã?§ä¸€è‡´",

// Paste Operations / Dialog
PasteErrorPaste	: "ãƒ–ãƒ©ã‚¦ã‚¶ãƒ¼ã?®ã‚»ã‚­ãƒ¥ãƒªãƒ†ã‚£è¨­å®šã?«ã‚ˆã‚Šã‚¨ãƒ‡ã‚£ã‚¿ã?®è²¼ã‚Šä»˜ã?‘æ“?ä½œã?Œè‡ªå‹•ã?§å®Ÿè¡Œã?™ã‚‹ã?“ã?¨ã?Œã?§ã??ã?¾ã?›ã‚“ã€‚å®Ÿè¡Œã?™ã‚‹ã?«ã?¯æ‰‹å‹•ã?§ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰ã?®(Ctrl+V)ã‚’ä½¿ç”¨ã?—ã?¦ã??ã? ã?•ã?„ã€‚",
PasteErrorCut	: "ãƒ–ãƒ©ã‚¦ã‚¶ãƒ¼ã?®ã‚»ã‚­ãƒ¥ãƒªãƒ†ã‚£è¨­å®šã?«ã‚ˆã‚Šã‚¨ãƒ‡ã‚£ã‚¿ã?®åˆ‡ã‚Šå?–ã‚Šæ“?ä½œã?Œè‡ªå‹•ã?§å®Ÿè¡Œã?™ã‚‹ã?“ã?¨ã?Œã?§ã??ã?¾ã?›ã‚“ã€‚å®Ÿè¡Œã?™ã‚‹ã?«ã?¯æ‰‹å‹•ã?§ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰ã?®(Ctrl+X)ã‚’ä½¿ç”¨ã?—ã?¦ã??ã? ã?•ã?„ã€‚",
PasteErrorCopy	: "ãƒ–ãƒ©ã‚¦ã‚¶ãƒ¼ã?®ã‚»ã‚­ãƒ¥ãƒªãƒ†ã‚£è¨­å®šã?«ã‚ˆã‚Šã‚¨ãƒ‡ã‚£ã‚¿ã?®ã‚³ãƒ”ãƒ¼æ“?ä½œã?Œè‡ªå‹•ã?§å®Ÿè¡Œã?™ã‚‹ã?“ã?¨ã?Œã?§ã??ã?¾ã?›ã‚“ã€‚å®Ÿè¡Œã?™ã‚‹ã?«ã?¯æ‰‹å‹•ã?§ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰ã?®(Ctrl+C)ã‚’ä½¿ç”¨ã?—ã?¦ã??ã? ã?•ã?„ã€‚",

PasteAsText		: "ãƒ—ãƒ¬ãƒ¼ãƒ³ãƒ†ã‚­ã‚¹ãƒˆè²¼ã‚Šä»˜ã?‘",
PasteFromWord	: "ãƒ¯ãƒ¼ãƒ‰æ–‡ç« ã?‹ã‚‰è²¼ã‚Šä»˜ã?‘",

DlgPasteMsg		: "ãƒ–ãƒ©ã‚¦ã‚¶ãƒ¼ã?®<STRONG>ã‚»ã‚­ãƒ¥ãƒªãƒ†ã‚£è¨­å®š</STRONG>ã?«ã‚ˆã‚Šã‚¨ãƒ‡ã‚£ã‚¿ã?®è²¼ã‚Šä»˜ã?‘æ“?ä½œã?Œè‡ªå‹•ã?§å®Ÿè¡Œã?™ã‚‹ã?“ã?¨ã?Œã?§ã??ã?¾ã?›ã‚“ã€‚<BR>å®Ÿè¡Œã?™ã‚‹ã?«ã?¯æ‰‹å‹•ã?§ã‚­ãƒ¼ãƒœãƒ¼ãƒ‰ã?®(<STRONG>Ctrl+V</STRONG>)ã‚’å®Ÿè¡Œã?—ã?¦<STRONG>OK</STRONG>ã‚’æŠ¼ã?—ã?¦ã??ã? ã?•ã?„ã€‚",

// Color Picker
ColorAutomatic	: "è‡ªå‹•",
ColorMoreColors	: "ã??ã?®ä»–ã?®è‰²...",
...
DlgAnchorErrorName	: "ã‚¢ãƒ³ã‚«ãƒ¼å??ã‚’å¿…ã?šå…¥åŠ›ã?—ã?¦ã??ã? ã?•ã?„ã€‚",
...
DlgSpellNoSuggestions	: "- è©²å½“ã?ªã?— -",
DlgSpellProgress		: "ã‚¹ãƒšãƒ«ãƒ?ã‚§ãƒƒã‚¯å‡¦ç?†ä¸­...",
DlgSpellNoMispell		: "ã‚¹ãƒšãƒ«ãƒ?ã‚§ãƒƒã‚¯å®Œäº†: ã‚¹ãƒšãƒ«ã?®èª¤ã‚Šã?¯ã?‚ã‚Šã?¾ã?›ã‚“ã?§ã?—ã?Ÿ",
DlgSpellNoChanges		: "ã‚¹ãƒšãƒ«ãƒ?ã‚§ãƒƒã‚¯å®Œäº†: èªžå?¥ã?¯å¤‰æ›´ã?•ã‚Œã?¾ã?›ã‚“ã?§ã?—ã?Ÿ",
DlgSpellOneChange		: "ã‚¹ãƒšãƒ«ãƒ?ã‚§ãƒƒã‚¯å®Œäº†: ï¼‘èªžå?¥å¤‰æ›´ã?•ã‚Œã?¾ã?—ã?Ÿ",
DlgSpellManyChanges		: "ã‚¹ãƒšãƒ«ãƒ?ã‚§ãƒƒã‚¯å®Œäº†: %1 èªžå?¥å¤‰æ›´ã?•ã‚Œã?¾ã?—ã?Ÿ",

IeSpellDownload			: "ã‚¹ãƒšãƒ«ãƒ?ã‚§ãƒƒã‚«ãƒ¼ã?Œã‚¤ãƒ³ã‚¹ãƒˆãƒ¼ãƒ«ã?•ã‚Œã?¦ã?„ã?¾ã?›ã‚“ã€‚ä»Šã?™ã??ãƒ€ã‚¦ãƒ³ãƒ­ãƒ¼ãƒ‰ã?—ã?¾ã?™ã?‹?",
...
DlgSelectOpAvail	: "åˆ©ç”¨å?¯èƒ½ã?ªã‚ªãƒ—ã‚·ãƒ§ãƒ³",
...
DlgSelectBtnSetValue : "é?¸æŠžã?—ã?Ÿå€¤ã‚’è¨­å®š",
...
DlgDocLangDirLTR	: "å·¦ã?‹ã‚‰å?³ã?«æ–‡å­—è¡¨è¨˜ã?—ã?¾ã?™(LTR)",
DlgDocLangDirRTL	: "å?³ã?‹ã‚‰å·¦ã?«æ–‡å­—è¡¨è¨˜ã?—ã?¾ã?™(RTL)",
...
DlgDocDocTypeOther	: "ã??ã?®ä»–æ–‡æ›¸ã‚¿ã‚¤ãƒ—ãƒ˜ãƒƒãƒ€ãƒ¼",
DlgDocIncXHTML		: "XHTMLå®£è¨€ã‚’ã‚¤ãƒ³ã‚¯ãƒ«ãƒ¼ãƒ‰",
DlgDocBgColor		: "èƒŒæ™¯è‰²",
DlgDocBgImage		: "èƒŒæ™¯ç”»åƒ? URL",
DlgDocBgNoScroll	: "ã‚¹ã‚¯ãƒ­ãƒ¼ãƒ«ã?—ã?ªã?„èƒŒæ™¯",
...
// About Dialog
DlgAboutAboutTab	: "ãƒ?ãƒ¼ã‚¸ãƒ§ãƒ³æƒ…å ±",
DlgAboutBrowserInfoTab	: "ãƒ–ãƒ©ã‚¦ã‚¶æƒ…å ±",
DlgAboutVersion		: "ãƒ?ãƒ¼ã‚¸ãƒ§ãƒ³",
