...
oRegex.UrlOnChangeTestOther = /^((javascript:)|[#\/\.]|.*templateLogic|DownloadAsset)/gi ;
//                              '^((javascript:)|[#\/\.]|\\$templateLogic|DownloadAsset)', 'gi' ) ; 
...
function OnUrlChange()
{
	...
	var isOther = oRegex.UrlOnChangeTestOther.test( sUrl );
	...
	else if(isOther) //else if ( oRegex.UrlOnChangeTestOther.test( sUrl ) )
	{
		GetE('cmbLinkProtocol').value = '' ;
	}
